...
const DATE_TYPE: Array<string> = ['created_at', 'submission_date', 'published_on', 'awarded_on', 'retender_date'];
...
export class TenderEditComponent implements OnInit {
      ...
      if (param.id) {
        this.tenderService.getTenderDetails(param.id).subscribe((res: TenderObj) => {
          ...
          this.tenderForm.patchValue({
            ...
            industry: this.tender.industry ? this.tender.industry.name : '',
            codes: []
          });
  ...
  //   let opts = window.MyNamespace.picklist,
  //     textContent = this.monitorForm.controls["codesDescription"].value
  //       ? this.monitorForm.controls["codesDescription"].value
  //       : [],
  //     arr = [];
  //   arr = this.monitorForm.controls["codes"].value
  //     ? this.monitorForm.controls["codes"].value
  //     : [];
  ...
  //   this.monitorForm.controls["codes"].setValue(_.uniqBy(arr), {
  //     emitEvent: true
  //   });
  //   this.monitorForm.controls["codesDescription"].setValue(
  //     _.uniqBy(textContent)
  //   );
  //   this.callMonitorPreviewService();
  ...
  //   this.editService.getJSON(fileName).subscribe((res: any) => {
